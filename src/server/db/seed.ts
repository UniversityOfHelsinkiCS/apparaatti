...
async function seedCourses() {
  ...
  const courses = [
    ...
    makeCourse('kk-rumalu',   'KK-RUMALU',   COURSE_NAME.kkRumalu,   ORG.language, { min: 2, max: 2 }, { ...langUrns(LANG.sv),                                          ...helsinkiUrns(HKI.kielet) }),
    makeCourse('kk-enkaikki', 'KK-ENKAIKKI', COURSE_NAME.kkEnkaikki, ORG.language, { min: 3, max: 3 }, { ...langUrns(LANG.en),                                          ...helsinkiUrns(HKI.kielet) }),
    makeCourse('kk-eng201',   'KK-ENG201',   COURSE_NAME.kkEng201,   ORG.language, { min: 5, max: 5 }, { ...langUrns(LANG.en),                                          ...helsinkiUrns(HKI.kielet) }),
    ...
    makeCourse('kk-rukaikki', 'KK-RUKAIKKI', COURSE_NAME.kkRukaikki, ORG.language, { min: 3, max: 3 }, { ...langUrns(LANG.sv),                                          ...helsinkiUrns(HKI.kielet) }),
    makeCourse('kk-ruo205',   'KK-RUO205',   COURSE_NAME.kkRuo205,   ORG.language, { min: 2, max: 2 }, { ...langUrns(LANG.fi, LANG.sv),                                 ...helsinkiUrns(HKI.kielet) }),
    makeCourse('kk-rueri',    'KK-RUERI',    COURSE_NAME.kkRueri,    ORG.language, { min: 3, max: 3 }, { ...langUrns(LANG.sv),                                          ...helsinkiUrns(HKI.kielet) }),
