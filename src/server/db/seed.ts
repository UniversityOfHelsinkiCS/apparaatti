...
const ORG_NAME: Record<string, LocalizedName> = {
  ...
  d4141: {
    fi: 'Soveltava psykologia',
    en: 'Division of Applied Psychology',
    sv: 'Avdelningen för tillämpad psykologi',
  },
  h3456: {
    fi: 'Psykologian ja logopedian osasto',
    en: 'Department of Psychology and Logopedics',
    sv: 'Avdelningen för psykologi och logopedi',
  },
...
const COURSE_NAME: Record<string, LocalizedName> = {
  ...
  tkt10002: {
    fi: 'Tietorakenteet ja algoritmit',
    en: 'Data Structures and Algorithms',
    sv: 'Datastrukturer och algoritmer',
  },
  ...
  kkRumalu: {
    fi: 'Toisen kotimaisen kielen suullinen ja kirjallinen taito, ruotsi (CEFR B1)',
    en: 'Oral and Written Skills in the Second National Language, Swedish (CEFR B1)',
    sv: 'Muntlig och skriftlig färdighet i det andra inhemska språket, svenska (CEFR B1)',
  },
  ...
  kkRuo205: {
    fi: 'Repetera svenska - Ruotsin perusrakenteiden ja sanaston kertausta (CEFR A2)',
    en: 'Repetera svenska - Remedial course in Swedish (CEFR A2)',
    sv: 'Repetera svenska (CEFR A2)',
  },
  ...
  matGrad: {
    fi: 'Matematiikka valmistuville',
    en: 'Mathematics for Graduating Students',
    sv: 'Matematik för examinander',
  },
  tktMooc: { fi: 'Ohjelmointi MOOC', en: 'Programming MOOC', sv: 'Programmering MOOC' },
  h50FiOnline: {
    fi: 'Matemaattis-luonnontieteellinen verkkokurssi (fi)',
    en: 'Science online course (fi)',
    sv: 'Matematisk-naturvetenskaplig nätkurs (fi)',
  },
  h50FiContact: {
    fi: 'Matemaattis-luonnontieteellinen lähiopetuskurssi (fi)',
    en: 'Science contact course (fi)',
    sv: 'Matematisk-naturvetenskaplig närkurs (fi)',
  },
  h50FiBlended: {
    fi: 'Matemaattis-luonnontieteellinen monimuotokurssi (fi)',
    en: 'Science blended course (fi)',
    sv: 'Matematisk-naturvetenskaplig blendedkurs (fi)',
  },
  h50FiIndependent: {
    fi: 'Matemaattis-luonnontieteellinen itsenäinen opiskelu (fi)',
    en: 'Science independent study (fi)',
    sv: 'Matematisk-naturvetenskaplig självständig kurs (fi)',
  },
  h50FiExam: {
    fi: 'Matemaattis-luonnontieteellinen tentti (fi)',
    en: 'Science exam (fi)',
    sv: 'Matematisk-naturvetenskaplig tentamen (fi)',
  },
  h50SvOnline: {
    fi: 'Matemaattis-luonnontieteellinen verkkokurssi (sv)',
    en: 'Science online course (sv)',
    sv: 'Matematisk-naturvetenskaplig nätkurs (sv)',
  },
  h50SvContact: {
    fi: 'Matemaattis-luonnontieteellinen lähiopetuskurssi (sv)',
    en: 'Science contact course (sv)',
    sv: 'Matematisk-naturvetenskaplig närkurs (sv)',
  },
  h50SvBlended: {
    fi: 'Matemaattis-luonnontieteellinen monimuotokurssi (sv)',
    en: 'Science blended course (sv)',
    sv: 'Matematisk-naturvetenskaplig blendedkurs (sv)',
  },
  h50SvIndependent: {
    fi: 'Matemaattis-luonnontieteellinen itsenäinen opiskelu (sv)',
    en: 'Science independent study (sv)',
    sv: 'Matematisk-naturvetenskaplig självständig kurs (sv)',
  },
  h50SvExam: {
    fi: 'Matemaattis-luonnontieteellinen tentti (sv)',
    en: 'Science exam (sv)',
    sv: 'Matematisk-naturvetenskaplig tentamen (sv)',
  },
}
...
async function seedCourses() {
  ...
  const courses = [
    makeCourse(
      'tkt10001',
      'TKT10001',
      COURSE_NAME.tkt10001,
      ORG.science,
      { min: 5, max: 5 },
      { ...apparaattiUrns(TAG.kktMat), ...langUrns(LANG.fi), ...helsinkiUrns(HKI.luonnontieteet) }
    ),
    makeCourse(
      'tkt10002',
      'TKT10002',
      COURSE_NAME.tkt10002,
      ORG.science,
      { min: 10, max: 10 },
      { ...apparaattiUrns(TAG.kktMat), ...langUrns(LANG.en), ...helsinkiUrns(HKI.luonnontieteet) }
    ),
    makeCourse(
      'tkt10003',
      'TKT10003',
      COURSE_NAME.tkt10003,
      ORG.science,
      { min: 5, max: 5 },
      { ...apparaattiUrns(TAG.kktMat), ...opinfiUrns(OPINFI.online), ...helsinkiUrns(HKI.luonnontieteet) }
    ),

    makeCourse(
      'mat11001',
      'MAT11001',
      COURSE_NAME.mat11001,
      ORG.science,
      { min: 10, max: 10 },
      { ...apparaattiUrns(TAG.kktMat), ...langUrns(LANG.fi), ...helsinkiUrns(HKI.luonnontieteet) }
    ),
    ...
    makeCourse(
      'kk-rumalu',
      'KK-RUMALU',
      COURSE_NAME.kkRumalu,
      ORG.language,
      { min: 2, max: 2 },
      { ...apparaattiUrns(TAG.kktMat, TAG.kktHum, TAG.kktVal), ...langUrns(LANG.sv), ...helsinkiUrns(HKI.kielet) }
    ),
    makeCourse(
      'kk-enkaikki',
      'KK-ENKAIKKI',
      COURSE_NAME.kkEnkaikki,
      ORG.language,
      { min: 3, max: 3 },
      { ...apparaattiUrns(TAG.kktMat, TAG.kktHum, TAG.kktVal), ...langUrns(LANG.en), ...helsinkiUrns(HKI.kielet) }
    ),
    makeCourse(
      'kk-eng201',
      'KK-ENG201',
      COURSE_NAME.kkEng201,
      ORG.language,
      { min: 5, max: 5 },
      { ...apparaattiUrns(TAG.kktMat, TAG.kktHum, TAG.kktVal), ...langUrns(LANG.en), ...helsinkiUrns(HKI.kielet) }
    ),
    makeCourse(
      ...
      ORG.language,
      { min: 3, max: 3 },
      { ...apparaattiUrns(TAG.kktMat, TAG.kksKor), ...langUrns(LANG.en), ...helsinkiUrns(HKI.kielet) }
    ),

    makeCourse(
      'kk-rukaikki',
      'KK-RUKAIKKI',
      COURSE_NAME.kkRukaikki,
      ORG.language,
      { min: 3, max: 3 },
      { ...apparaattiUrns(TAG.kktMat, TAG.kktHum, TAG.kktVal), ...langUrns(LANG.sv), ...helsinkiUrns(HKI.kielet) }
    ),
    makeCourse(
      'kk-ruo205',
      'KK-RUO205',
      COURSE_NAME.kkRuo205,
      ORG.language,
      { min: 2, max: 2 },
      {
        ...apparaattiUrns(TAG.kktMat, TAG.kktHum, TAG.kktVal),
        ...langUrns(LANG.fi, LANG.sv),
        ...helsinkiUrns(HKI.kielet),
      }
    ),
    makeCourse(
      'kk-rueri',
      ...
      ORG.language,
      { min: 3, max: 3 },
      { ...apparaattiUrns(TAG.kktMat, TAG.kksKor), ...langUrns(LANG.sv), ...helsinkiUrns(HKI.kielet) }
    ),
    ...
    makeCourse(
      ...
      ORG.bio,
      { min: 5, max: 5 },
      { ...apparaattiUrns(TAG.kktBio), ...langUrns(LANG.fi), ...helsinkiUrns(HKI.luonnontieteet) }
    ),
    makeCourse(
      'tal1001',
      'TAL1001',
      ...
      ORG.social,
      { min: 5, max: 5 },
      { ...apparaattiUrns(TAG.kktVal), ...langUrns(LANG.fi), ...helsinkiUrns(HKI.yhteiskunta) }
    ),
    makeCourse(
      'psy1001',
      'PSY1001',
      ...
      ORG.psych,
      { min: 5, max: 5 },
      { ...apparaattiUrns(TAG.kktHum), ...langUrns(LANG.fi) }
    ),
    makeCourse(
      'oik1001',
      'OIK1001',
      ...
      ORG.law,
      { min: 5, max: 5 },
      { ...apparaattiUrns(TAG.kktOik), ...langUrns(LANG.fi) }
    ),
    makeCourse(
      'laa1001',
      'LAA1001',
      ...
      ORG.medicine,
      { min: 10, max: 10 },
      { ...apparaattiUrns(TAG.kktLaa), ...langUrns(LANG.fi) }
    ),
    ...
    makeCourse(
      ...
      ORG.science,
      { min: 5, max: 5 },
      { ...apparaattiUrns(TAG.kktMat, TAG.kksVal), ...langUrns(LANG.fi), ...helsinkiUrns(HKI.luonnontieteet) }
    ),
    makeCourse(
      'tkt-mooc',
      'TKT-MOOC',
    ...
    makeCourse(
      ...
      'KK-AIAKVU1OP',
      COURSE_NAME.h50FiIndependent,
      ORG.science,
      { min: 2, max: 2 },
      { ...apparaattiUrns(TAG.kktMat, TAG.kksAlm), ...langUrns(LANG.fi), ...helsinkiUrns(HKI.luonnontieteet) }
    ),
    makeCourse(
      'h50-fi-studyplace-exam',
      'KK-AIAKVU1OP',
      COURSE_NAME.h50FiExam,
      ORG.science,
      { min: 2, max: 2 },
      { ...apparaattiUrns(TAG.kktMat), ...langUrns(LANG.fi), ...helsinkiUrns(HKI.luonnontieteet) }
    ),
    ...
    makeCourse(
      ...
      'KK-RUMALU',
      COURSE_NAME.h50SvOnline,
      ORG.science,
      { min: 2, max: 2 },
      { ...apparaattiUrns(TAG.kktMat), ...langUrns(LANG.sv), ...helsinkiUrns(HKI.luonnontieteet) }
    ),
    makeCourse(
      'h50-sv-studyplace-contact',
      'KK-RUMALU',
      COURSE_NAME.h50SvContact,
      ORG.science,
      { min: 2, max: 2 },
      { ...apparaattiUrns(TAG.kktMat), ...langUrns(LANG.sv), ...helsinkiUrns(HKI.luonnontieteet) }
    ),
    ...
    makeCourse(
      ...
      'KK-RUMALU',
      COURSE_NAME.h50SvIndependent,
      ORG.science,
      { min: 2, max: 2 },
      { ...apparaattiUrns(TAG.kktMat, TAG.kksAlm), ...langUrns(LANG.sv), ...helsinkiUrns(HKI.luonnontieteet) }
    ),
    makeCourse(
      'h50-sv-studyplace-exam',
      'KK-RUMALU',
      COURSE_NAME.h50SvExam,
      ORG.science,
      { min: 2, max: 2 },
      { ...apparaattiUrns(TAG.kktMat), ...langUrns(LANG.sv), ...helsinkiUrns(HKI.luonnontieteet) }
    ),
  ...
  courses.forEach((course, courseIndex) => {
    ...
    for (let i = 0; i < numRealizations; i++) {
      ...
      if (semester.name.includes(SPRING_LABEL) && i === 1 && course.groupId === ORG.science) {
        urns = {
          ...urns,
          [`${URN}:kk-apparaatti`]: [...(urns[`${URN}:kk-apparaatti`] || []), `${URN}:kk-apparaatti:${TAG.kksVal}`],
        }
      }
      if (course.courseCode.startsWith(KK_CODE_PREFIX) && i === 2) {
        urns = {
          ...urns,
          [`${URN}:kk-apparaatti`]: [...(urns[`${URN}:kk-apparaatti`] || []), `${URN}:kk-apparaatti:${TAG.kksInt}`],
        }
      }
...
async function seedCurCuRelations(realizations: any[]) {
  ...
  const relations = realizations.map(r => makeCurCu(r.id, r.id.substring(0, r.id.lastIndexOf(CUR_INFIX))))
