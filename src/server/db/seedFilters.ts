    ...
    variants: [
      {
        ...
        options: [
          { id: 'intensive_3_previous', name: { fi: 'Intensiivijakso 1', sv: 'Intensivperiod 1', en: 'Intensive Period 1' }, defaultSelection: true },
          { id: 'period_1', name: { fi: '1. periodi', sv: '1. period', en: '1. period' }, defaultSelection: true },
          { id: 'period_2', name: { fi: '2. periodi', sv: '2. period', en: '2. period' }, defaultSelection: true },
          { id: 'period_3', name: { fi: '3. periodi', sv: '3. period', en: '3. period' }, defaultSelection: true },
          { id: 'period_4', name: { fi: '4. periodi', sv: '4. period', en: '4. period' }, defaultSelection: true },
          { id: 'intensive_3', name: { fi: 'Intensiivijakso 2', sv: 'Intensivperiod 2', en: 'Intensive Period 2' }, defaultSelection: true },
        ],
      },
    ],
  },
    ...
    variants: [
      {
        ...
        options: [
          { id: 'online', name: { fi: 'Etäopetus', sv: 'Distans- eller nätstudier', en: 'Online or remote study' }, defaultSelection: true },
          { id: 'independent', name: { fi: 'Itsenäinen opiskelu', sv: 'Självständiga studier', en: 'Independent study' }, defaultSelection: true },
          { id: 'contact', name: { fi: 'Lähiopetus', sv: 'Närundervisning', en: 'Face-to-face teaching' }, defaultSelection: true },
          { id: 'blended', name: { fi: 'Monimuoto-opetus', sv: 'Blended learning', en: 'Blended learning' }, defaultSelection: true },
          { id: 'exam', name: { fi: 'Tentti', sv: 'Tentamen', en: 'Exam' }, defaultSelection: true },
        ],
      },
    ],
  },
