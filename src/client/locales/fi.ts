export default {
  ...
  v2: {
    ...
    noRecommendations: {
      ...
      resetConfirmationConfirm: 'Nollaa valinnat',
    ...
    feedback: {
      ...
      sendMetadataInfo:
        'valitsemalla tämän lähetät lomakkeen mukana filtterivalintasi ja saamasi suositukset, palaute on silti anonyymi',
      viewMetadata: 'Näytä metatiedot',
      metadataDialogTitle: 'Metatietojen esikatselu',
      metadataDialogDescription: 'Tässä näkyvät metatiedot, jotka voidaan lähettää palautteen mukana.',
      send: 'Lähetä palaute',
      cancel: 'Peruuta',
