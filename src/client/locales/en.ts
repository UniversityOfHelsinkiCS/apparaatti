export default {
  ...
  'form': {
    ...
    'primaryLanguageExplanation': 'Your language of general education, i.e. the language in which you have completed the mother tongue syllabus of a Finnish comprehensive school and/or upper secondary school, affects the completion of your studies. Read more detailed instructions on the Study Service page',
